...
function Quiz15() {
    ...
    return (
        <div>
            ...
            <Box mt={4}>
              <Button variant="contained" color="primary" className={classes.button}><Link className="next-link" exact="true" to="/lessons/15">Return to Lesson 15</Link></Button>
              <br/>
              <Button variant="contained" color="primary" className={classes.button}><Link className="next-link" exact="true" to="/lessons/16">Next Lesson: The Present Progressive and Unique Pronoun Placement →</Link></Button>
            </Box>
            <Copyright />
      </div>
    )
