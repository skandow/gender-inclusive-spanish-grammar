...
function Quiz18() {
    ...
    return (
        <div>
            ...
            <Box mt={4}>
                <Link className="next-link" exact="true" to="/lessons/18">Return to Lesson 18</Link>
                <br/>
                <Link className="next-link" exact="true" to="/lessons/19">Next Lesson: Possessive Adjectives →</Link>
            </Box>
            <Copyright />
      </div>
    )
