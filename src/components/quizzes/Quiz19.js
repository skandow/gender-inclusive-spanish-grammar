...
function Quiz19() {
    ...
    return (
        <div>
            ...
            {percentage ?
              <Fade right> 
                <h2>You got {score} out of 16 correct. Percentage: {percentage}</h2>
              </Fade>
            : null}
            </div>
            <Box mt={4}>
                <Button variant="contained" color="primary" className={classes.button}><Link className="next-link" exact="true" to="/lessons/19">Return to Lesson 19</Link></Button>
                <br/>
                <Button variant="contained" color="primary" className={classes.button}><Link className="next-link" exact="true" to="/lessons/20">Next Lesson: Demonstrative Adjectives & Pronouns →</Link></Button>
            </Box>
            <Copyright />
      </div>
    )
