...
function Lesson18() {
    ...
    return (
      <div className="lesson">
          ...
          <Box mt={4}>
            <Button variant="contained" color="primary" className={classes.button}><Link className="next-link" exact="true" to="/quizzes/18">Take Quiz!</Link></Button>
            <br/>
            <Button variant="contained" color="primary" className={classes.button}><Link className="next-link" exact="true" to="/lessons/19">Next Lesson: Possessive Adjectives & Pronouns →</Link></Button>
          </Box>
          <Copyright />
      </div>
    );
