...
function Lesson20() {
    ...
    return (
      <div className="lesson">
          ...
          <Link style={{display: "inline-block"}} className="next-link" exact="true" to="/quizzes/20">Take Quiz!</Link>
          <Link style={{display: "inline-block"}} className="next-link" exact="true" to="/final_message">Next Steps →</Link>
      </div>
    );
  }
