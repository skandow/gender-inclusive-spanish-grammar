    ...
    return (
      <div className="lesson">
          ...
          <div style={{textAlign: "left"}}>
            ...
            <p className="example"><strong><em>He</em> is watching a movie.</strong>
            <br/>
            ...
            <h3 id="subject-pronoun-header">A First Look at Spanish Subject Pronouns:</h3>
            <div>
                ...
                <caption>Spanish Subject Pronouns</caption>
                    ...
                    <tbody>
                        ...
                        <tr><td colSpan="2" style={{backgroundColor: "#b81140"}} lang="es">vosotres<sup><HashLink className="footnote-link" exact="true" to={"/lessons/2#footnote1"}>*</HashLink></sup></td></tr>
                        <tr>
                        ...
                        <tr>
                            <td colSpan="2" lang="es" id="footnote1" style={{backgroundColor: "#006341"}}>usted</td>
                            <td colSpan="2" lang="es" style={{backgroundColor: "#006341"}}>ustedes</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <p className="footnote"><sup>*</sup>There are several forms of non-binary Spanish subject pronouns.  The final "e" in each
            ...
            <dl>
                <dt>First Person Singular</dt>
                    <dd>This is the most straight-forward English-to-Spanish translation.  <em>I</em> in 
                        English becomes <em>yo</em> in Spanish.
                        <br/>
                ...
                <dt>Second Person Singular</dt>
                    ...
                    below when discussing <strong id="you-conditions">Second Person Plural</strong>. The context tells which of these seven
                ...
                <dt>First Person Plural</dt>
                    <dd>The plural Spanish pronouns rely heavily on gender.  Let's look at how native Spanish speakers
                        ...
                        as non-binary or non-gender-conforming, such as:
                        <ul>
                        ...
                        <em lang="es"> nosotres</em> should you wish to use them in ways deemed "unconventional" for standard
                        Spanish grammar.
