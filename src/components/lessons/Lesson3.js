...
function Lesson3() {
    ...
    return (
      <div className="lesson">
          ...
          <div style={{textAlign: "left"}}>
            ...
            <ol>
                <li>The chart follows a very similar pattern to the Spanish Subject Pronoun chart.  Take a look 
                    at this <HashLink exact="true" to="/lessons/2#subject-pronoun-header">reminder</HashLink> if you need
                    it.
                </li>
                ...
                <li>Because <em style={{color: "#006341"}}>usted</em> and <em style={{color: "#006341"}}>ustedes</em> appear in the third-person singular and plural 
                    ...
                    of the sentence when using verbs associated with third-person singular or plural subjects.
                </li>
            </ol>
          ...
          <Box mt={4}>
            <Button variant="contained" color="primary" className={classes.button}><Link className="next-link" exact="true" to="/quizzes/3">Take Quiz!</Link></Button>
            <br/>
