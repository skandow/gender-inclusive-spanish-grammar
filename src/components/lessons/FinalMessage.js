...
function FinalMessage() {
    ...
    return (
      <div className="lesson">
        ...
        <ul>
            <li>Subject Pronoun/Prepositional Pronoun: <span style={{border: "1px solid black", padding: "2px"}}>{subjectPronoun}</span> </li>
            <li>Direct Object Pronoun: <span style={{border: "1px solid black", padding: "2px"}}>{directObjectPronoun}</span></li>
            <li>Demonstrative Adjective/Pronoun (near): <span style={{border: "1px solid black", padding: "2px"}}>{demonstrativePronounNear}</span></li>
            <li>Demonstrative Adjective/Pronoun (far): <span style={{border: "1px solid black", padding: "2px"}}>{demonstrativePronounFar}</span></li>
            <li>Demonstrative Adjective/Pronoun (very far): <span style={{border: "1px solid black", padding: "2px"}}>{demonstrativePronounVeryFar}</span></li>
        </ul>
