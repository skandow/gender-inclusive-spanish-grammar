    ...
    return (
      <div className="lesson">
          ...
          <div style={{textAlign: "left"}}>
            ...
            has six (and actually, there is one more that is utilized much less than the others)!  
            ...
            significant other = <em lang="es" id="footnote-2">novio/novia/novie</em><br/>
            ...
            <p className="footnote"><sup>*</sup> Note the spelling change required for the word <em lang="es">amigue </em> 
            ...
            <dl>
                <dt>Other Words to Describe People:</dt>
                    <dd>Depending on where you are in the Spanish-speaking world, the following words could
                        ...
                        young girl = <em lang="es" id="footnote-3">niña</em><br/>
                        young genderqueer person = <em lang="es">niñe</em>
                        </p>
                        <p className="footnote"><sup>*</sup> Note once again that there is a spelling 
                ...
                <dt>Professions:</dt>  
                    <dd>
                        A similar rule exists for people of a particular gender that work in certain professions, though 
                ...
                <dt>Groups of People:</dt>
                    <dd>
                        <p>As we saw with plural object pronouns, the endings used for the various gendered forms of 
                        ...
                        precedent for using the <em>-es</em> plural endings of these words if you sense the presence of a non-binary 
          ...
          <Box mt={4}>
            <Button variant="contained" color="primary" className={classes.button}><Link className="next-link" exact="true" to="/quizzes/4">Take Quiz!</Link></Button>
            <br/>
            <Button variant="contained" color="primary" className={classes.button}><Link className="next-link" exact="true" to="/lessons/5">Next Lesson: Adjectives →</Link></Button>
          </Box>
          <Copyright />
      </div>
    );
